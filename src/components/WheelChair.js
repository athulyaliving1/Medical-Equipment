...
import DriveMedicalSilverSport2WheelchairWithFixedArms from "./Assets/wheelchair-fixed-arms-legrest.jpg";
import HeavyDutyWheelChairWithExtendedLegRest from "./Assets/heavy-duty-powder-coated-wheel-chair.jpg";
import JazyPowerChairWithMidWheelDrive from "./Assets/jazy-power-chair.jpg";
import MobilityFrontierPowerWheelChairForDisabled from "./Assets/magic-mobility-frontier.jpg";
...
Beginner Friendly
              ...
              <div class="">
                <img
                  ...
                  src={DriveMedicalSilverSport2WheelchairWithFixedArms}
                  alt="Colors"
                />
              </div>
              <h1 class="mt-10 text-gray-800 opacity-90  md:text-xl font-semibold cursor-pointer text-center">
                Drive Medical Silver Sport 2 Wheelchair With Fixed Arms
              </h1>
              <div class="">
...
Beginner Friendly
              ...
              <div class="">
                <img
                  class="w-full rounded-xl"
                  src={JazyPowerChairWithMidWheelDrive}
                  alt="Colors"
                />
              </div>
              <h1 class="mt-16 text-gray-800 md:text-xl font-semibold  cursor-pointer opacity-90  text-center">
                Jazy Power Chair With Mid Wheel Drive
              </h1>
              <div class="">
                {/* <div class="flex space-x-1 items-center">
  <span>
  ...
  <p>Vanilla JS</p>
            ...
            <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 relative">
              ...
              <div class="">
                <img
                  class="w-full rounded-xl"
                  src={MobilityFrontierPowerWheelChairForDisabled}
                  alt="Colors"
                />
              </div>
              <h1 class="mt-16 text-gray-800 opacity-90  md:text-xl font-semibold cursor-pointer text-center">
                Mobility Frontier Power Wheel Chair For Disabled
              </h1>
              <div class="">
                <button class="mt-4 text-xl w-full text-white bg-pink-500 py-2 rounded-xl shadow-lg">
                  Enquiry
