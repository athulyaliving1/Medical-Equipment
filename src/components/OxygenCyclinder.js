...
import CompleteOxygenCylinderKit from "./Assets/equip_oxygen-cyclinder.jpg";
import OxygenFlowmeterForOxygenCylinder from "./Assets/oxygen-flowmeter.jpg";
import PortableOxygenCylinder from "./Assets/oxygen-cylinder-kit-home-use.jpg";
import HighFlowNasalOxygenMask from "./Assets/mask.jpg";

function OxygenCyclinder() {
  return (
    ...
    Beginner Friendly
              ...
              <div class="">
                <img
                  class="w-full rounded-xl"
                  src={OxygenFlowmeterForOxygenCylinder}
                  alt="Colors"
                />
              </div>
...
export default OxygenCyclinder;
